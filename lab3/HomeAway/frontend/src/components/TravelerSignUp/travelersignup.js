...
import {travelerSignupMutation} from '../../mutation/mutations'
...
class travelersignup extends Component 
{
    ...
    submitLogin = (e) => {
        ...
        if(this.state.firstname == "" || this.state.lastname == "" || this.state.traveleremail == "" || this.state.travelerpassword == "")
            ...
            this.props.travelerSignupMutation({
                variables : {
                ...
                if(response.data.addTraveler.email===null)
                {
                    this.setState({
                        flag:false
                    })
                    // localStorage.setItem('cookieT',response.data.addTraveler.email)
                }
                else{
                    this.setState({
                        flag:true
...
export default compose(
    graphql(travelerSignupMutation, { name: "travelerSignupMutation" })
)(travelersignup);