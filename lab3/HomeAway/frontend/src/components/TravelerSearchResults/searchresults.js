...
import {TravelerBookingMutation} from '../../mutation/mutations'
import {travelerSearchResultsQuery} from '../../queries/queries'
...
class searchresults extends Component
{
    ...
    componentDidMount(){
        ...
        this.props.client.query({
            query : travelerSearchResultsQuery,
            variables : {
                email : emailT
            }
        }).then(response => {
            console.log("\nThe response obtained after successfully retreiving properties based on search : ");
            console.log(JSON.stringify(response.data.searchResults));
            this.setState({
                information : response.data.searchResults.propertyDetails
            })
            // alert("Success!")
        }).catch(error => {
            console.log("Some error occured in getting proerty details based on search: "+error);
    ...
    BookProperty = (e) => {
        ...
        this.props.TravelerBookingMutation({
            variables : {
...
export default withApollo(compose(
    graphql(TravelerBookingMutation, { name: "TravelerBookingMutation" })
)(searchresults));