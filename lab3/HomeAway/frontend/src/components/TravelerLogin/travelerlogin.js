...
class travelerlogin extends Component {
    ...
    onSubmit(values) {
        ...
        this.props.client.query({
            ...
            console.log("\nThe response obtained after success in traveler login is : ");
            console.log(JSON.stringify(response.data));
            if(response.data.loginTraveler.email === null ){
                this.setState({
                    flag: false
                })
                ...
                localStorage.setItem('setEmailId', response.data.loginTraveler.email);
                localStorage.setItem('setFirstname', response.data.loginTraveler.firstname);
                localStorage.setItem('setLastname', response.data.loginTraveler.lastname);
            }
        }).catch(error => {
