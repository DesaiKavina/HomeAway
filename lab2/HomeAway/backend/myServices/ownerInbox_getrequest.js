...
router.get('/ownerInbox/:email', function(req,res){
    ...
    kafka.make_request('ownerinbox_get',req.body, function(err,results){
        ...
        {
            console.log("\n--------- Extracted owner inbox data from the mongoDB collection ----------");
            res.writeHead(200,{
                'Content-Type' : 'text/plain'
            })
